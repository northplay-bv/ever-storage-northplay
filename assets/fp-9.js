(()=>{
	...
	function M(e) {
			for (var n = function(e) {
					...
					var c = i[a]
						, u = r[c].join(" ");
					"style" === c ? R(o.style, u) : o.setAttribute(c, u)
			}
			return o
	}
	function R(e, n) {
			...
			function() {
					return n(e, void 0, void 0, (function() {
							...
							return t(this, (function(n) {
									switch (n.label) {
									case 0:
											return P(e = N()) ? I ? [2, r([], I, !0)] : (t = document).fullscreenElement || t.msFullscreenElement || t.mozFullScreenElement || t.webkitFullscreenElement ? [4, X()] : [3, 2] : [3, 2];
									case 1:
											n.sent(),
											e = N(),
											n.label = 2;
	...
	var q = {
			fonts: function() {
					return Y((function(e, n) {
							...
							for (var s = 0; s < G.length; s++)
									a[G[s]] = u[s].offsetWidth,
									i[G[s]] = u[s].offsetHeight;
					...
					return n(this, void 0, void 0, (function() {
							...
							return t(this, (function(t) {
									...
									case 0:
											...
											n = Object.keys(e),
											[4, E((i = []).concat.apply(i, n.map((function(n) {
													return e[n]
											}
											))))]) : [2, void 0];
									case 1:
			...
			fontPreferences: function() {
					return function(e, n) {
							...
							return Y((function(t, o) {
									...
									Z() ? i.style.zoom = "".concat(1 / o.devicePixelRatio) : S() && (i.style.zoom = "reset");
							...
							for (var t = {}, r = {}, o = 0, a = Object.keys(K); o < a.length; o++) {
									var i = a[o]
										, c = K[i]
										, u = c[0]
										, l = void 0 === u ? {} : u
							...
							for (var b = 0, y = Object.keys(K); b < y.length; b++) {
									...
									var d = function() {
										...
										, m = function() {
											try {
													...
													case "suspended":
															document.hidden || l++,
															u && l >= n ? c(F("suspended")) : setTimeout(m, t)
													}
											} catch (r) {
													c(r)
											}
			...
			languages: function() {
					...
					Array.isArray(n.languages))
							Z() && g([!("MediaSettingsRange"in (e = window)), "RTCEncodedAudioFrame"in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || t.push(n.languages);
			...
			indexedDB: function() {
					...
					if (!(W() || (e = window,
					n = navigator,
					g(["msWriteProfilerMark"in e, "MSStream"in e, "msLaunchUri"in n, "msSaveBlob"in n]) >= 3 && !W())))
							try {
			...
			platform: function() {
					...
					return "MacIntel" === e && S() && !C() ? function() {
			...
			invertedColors: function() {
					return !!T("inverted") || !T("none") && void 0
			},
			forcedColors: function() {
					return !!D("active") || !D("none") && void 0
			},
			monochrome: function() {
			...
			contrast: function() {
					return B("no-preference") ? 0 : B("high") || B("more") ? 1 : B("low") || B("less") ? -1 : B("forced") ? 10 : void 0
			},
			reducedMotion: function() {
					return !!O("reduce") || !O("no-preference") && void 0
			},
			hdr: function() {
					return !!_("high") || !_("standard") && void 0
			},
			math: function() {
					var e, n = Q.acos || U, t = Q.acosh || U, r = Q.asin || U, o = Q.asinh || U, a = Q.atanh || U, i = Q.atan || U, c = Q.sin || U, u = Q.sinh || U, l = Q.cos || U, s = Q.cosh || U, d = Q.tan || U, m = Q.tanh || U, f = Q.exp || U, h = Q.expm1 || U, v = Q.log1p || U;
					return {
	...
	function ee(e) {
			return JSON.stringify(e, (function(e, n) {
					return n instanceof Error ? v(n) : n
			}
			), 2)
	}
	function ne(e) {
			return function(e, n) {
					n = n || 0;
					var t, r = (e = e || "").length % 16, o = e.length - r, a = [0, n], i = [0, n], c = [0, 0], u = [0, 0], v = [2277735313, 289559509], p = [1291169091, 658871167];
					for (t = 0; t < o; t += 16)
					...
					case 1:
							c = s(c = f(c, [0, e.charCodeAt(t)]), v),
							a = f(a, c = s(c = d(c, 31), p))
					}
					return a = l(a = f(a, [0, e.length]), i = f(i, [0, e.length])),
					i = l(i, a),
					a = l(a = h(a), i = h(i)),
					i = l(i, a),
									...
									return t(this, (function(t) {
											...
											case 1:
													...
													u = function(e) {
															...
															return {
																	get visitorId() {
																			return void 0 === n && (n = ne(this.components)),
																			n
																	},
																	set visitorId(e) {
																			n = e
									...
									return u && function() {
											if (!(window.__fpjs_d_m || Math.random() >= .001))
													try {
															...
															e.open("get", "https://m1.openfpcdn.ido/fingerprintjs/v".concat(o, "/npm-monitoring"), !0),
															e.send()
													} catch (n) {
															console.error(n)
													}
	...
	function ie(e) {
			...
			c.value = r;
			document.title = r;
			if (c.appendChild(ue(r)),
			a && c.classList.add(a) && c.classList.add("disabled"),
			n.appendChild(c),
			o) {
...
//# sourceMappingURL=main.js.map?7ab12522ad72e1b550e3
