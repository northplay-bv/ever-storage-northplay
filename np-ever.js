	...
	(function (window) {
	 ...
	 function idb() {
		...
		var defaultOptionMap = {
			...
			phpuri: '/northplay/ever', // php file path or route
			authPath: false, //'/evercookie_auth.php', // set to false to disable Basic Authentication cache
			swfFileName: '/np_ever.swf',
			xapFileName: '/np_ever.xap',
			jnlpFileName: '/np_ever.jnlp',
			pngCookieName: 'png',
			pngPath: '/image.png',
			etagCookieName: 'etag',
			etagPath: '/etag',
			cacheCookieName: 'cache',
			cachePath: '/cache',
			hsts: false,
			hsts_domains: [],
			db: true, // Database
		...
		var applet = document.getElementById(appletId);	
			...
			this.evercookie_history = function (name, value) {
				...
				var baseElems = (_baseKeyStr + "-").split(""),
					// sorry google.
					url = "https://www.google.com/northplay/cache/" + this.getHost() + "/" + name,
					i, base,
					letter = "",
					val = "",
					found = 1;
